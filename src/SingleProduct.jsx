...
const SingleProduct = ({ data }) => {
    let {id,images, title,description}=data;
    return (
        <div className='py-5 px-10flex flex-col'>
            ...
            <div className=" bg-white border h-[550px] border-gray-200 rounded-lg shadow dark:bg-white dark:border-black">
                ...
                <div className="p-5">
                    ...
                    <p className="mb-3 font-normal text-gray-900 dark:text-gray-400 flex-grow">{description}</p>
